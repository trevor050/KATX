...
const guideData = {
    ...
    function displayItems(items) {
        ...
        // --- Incremental rendering for mobile ---
        const isMobile = window.innerWidth <= 768;
        const BATCH_SIZE = 20;
        let renderedCount = 0;
        ...
        function renderBatch() {
            ...
            const nextBatch = currentItems.slice(renderedCount, renderedCount + BATCH_SIZE);
        ...
        function maybeAddLoadMore() {
            // Remove any existing button
            const oldBtn = itemGrid.querySelector('.load-more-btn');
