    ...
    fusion: [
        ...
        function displayItems(items) {
            ...
            function updateVisibleItems() {
                ...
                // Increase buffer rows from 1 to 3
                const bufferRows = 3;
                ...
                const firstVisibleRow = Math.max(0, Math.floor((scrollTop - gridTop) / itemCardHeight) - bufferRows); // Buffer above
                const lastVisibleRow = Math.ceil((scrollTop + viewportHeight - gridTop) / itemCardHeight) + bufferRows; // Buffer below
