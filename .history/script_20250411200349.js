...
console.log("franko shen!")


fetch("htps://opensheet.vercel.app/1roR6dtZzzr_LQGDQ6vpuJdxRFRrgk_L3LHltBz7iVcY/Values")
  .then(res => res.json())
  .then(data => {
            ...
            if (isMobile) {
                ...
                requestAnimationFrame(() => {
                    ...
                    window.cardUpdateInterval = setInterval(() => {
                        console.log('INTERVAL CHECK - calling updateVisibleItems');
                        updateVisibleItems();
                    }, 500);
                });
