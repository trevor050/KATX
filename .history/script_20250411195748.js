...
const guideData = {
    ...
    // --- Initial Load ---
    console.log('Calling fetchData...'); // LOG: Before fetchData call
    fetchData();
...
// --- Initialize Mobile Features --- // This section seems problematic / potentially duplicated or misplaced
// Commenting out potentially problematic / old code below line 2724 
/*
